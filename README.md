...
| release, plugin version | the product is released as a whole (1.4.3); each of the four plugins has its own version (workflow 0.25.3 in 1.4.3), and `releases/<release>.json` records which plugin versions a release carries |
