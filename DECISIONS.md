...
| [2026-09-23-claude-md-is-read-once-at-session-start-0436](docs/decisions/2026-09-23-claude-md-is-read-once-at-session-start-0436.md) | CLAUDE.md is read once at session start and held in context on every turn, so a mid-session rewrite does not apply and its size is paid each turn | accepted | 2026-09-23 |
...
| [2026-09-23-pinning-a-marketplace-or-a-plugin-source-25be](docs/decisions/2026-09-23-pinning-a-marketplace-or-a-plugin-source-25be.md) | A machine follows a signed release tag through the marketplace source, and verify stays the check | accepted | 2026-09-23 |
...
| [2026-09-24-guardrails-never-wait-on-a-person-except-649e](docs/decisions/2026-09-24-guardrails-never-wait-on-a-person-except-649e.md) | Guardrails never wait on a person, except before a rule is turned off or saved work is dropped | accepted | 2026-09-24 |
| [2026-09-24-guardrails-reads-a-sourced-or-executed-s-3445](docs/decisions/2026-09-24-guardrails-reads-a-sourced-or-executed-s-3445.md) | guardrails reads a sourced or executed script only when nothing earlier in the command can change it | proposed | 2026-09-24 |
| [2026-09-24-the-guard-s-tokenizer-stays-in-awk-the-n-44a4](docs/decisions/2026-09-24-the-guard-s-tokenizer-stays-in-awk-the-n-44a4.md) | The guard's tokenizer stays in awk: the Node parser matched it byte for byte but made every decision slower and Node a hard requirement | accepted | 2026-09-24 |
| [2026-09-24-the-preflight-test-times-the-runtime-pro-2fb1](docs/decisions/2026-09-24-the-preflight-test-times-the-runtime-pro-2fb1.md) | The preflight test times the runtime probe itself under load; the product's 20 s limit and its lack of an option stay | proposed | 2026-09-24 |
| [2026-09-24-the-usage-ledger-skips-an-empty-window-a-aea2](docs/decisions/2026-09-24-the-usage-ledger-skips-an-empty-window-a-aea2.md) | The usage ledger skips an empty window and is read only in the default scope | proposed | 2026-09-24 |
| [2026-09-24-the-usage-summary-compares-the-two-lates-fbf8](docs/decisions/2026-09-24-the-usage-summary-compares-the-two-lates-fbf8.md) | The usage summary compares the two latest screen readings and a same-count baseline | proposed | 2026-09-24 |
...
| [2026-09-25-compliance-lives-in-public-skilliton-as-39ef](docs/decisions/2026-09-25-compliance-lives-in-public-skilliton-as-39ef.md) | Compliance lives in public Skilliton as a projection of its evidence onto framework libraries through NIST CSF 2.0 | accepted | 2026-09-25 |
| [2026-09-25-converted-framework-text-is-reworded-in-31e5](docs/decisions/2026-09-25-converted-framework-text-is-reworded-in-31e5.md) | Converted framework text is reworded in the converter, never exempted from the vocabulary check | accepted | 2026-09-25 |
| [2026-09-25-the-soc-2-and-pci-dss-libraries-stay-out-8c57](docs/decisions/2026-09-25-the-soc-2-and-pci-dss-libraries-stay-out-8c57.md) | The SOC 2 and PCI DSS libraries stay out of public Skilliton under their publishers' terms | accepted | 2026-09-25 |
| [2026-09-26-compliance-engagements-run-inside-skilli-cbe3](docs/decisions/2026-09-26-compliance-engagements-run-inside-skilli-cbe3.md) | Compliance engagements run inside Skilliton, for any framework, and still never certify | accepted | 2026-09-26 |
| [2026-09-26-skilliton-becomes-a-private-repository-ebc3](docs/decisions/2026-09-26-skilliton-becomes-a-private-repository-ebc3.md) | Skilliton becomes a private repository | accepted | 2026-09-26 |
| [2026-09-26-the-fleet-is-every-company-computer-harn-e1d4](docs/decisions/2026-09-26-the-fleet-is-every-company-computer-harn-e1d4.md) | The fleet is every company computer, harnessed the same way through device management | accepted | 2026-09-26 |
