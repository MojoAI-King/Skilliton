...
Kind: Reference. Recorded 2026-09-17 by `scripts/rehearsals/projects.mjs`. Disposable folders, synthetic projects and throwaway keys only.
...
|---|---|---|
| N1 fresh project: preview writes nothing, apply creates layout 3, repeat apply changes nothing | PASS | preview exit 0, wrote nothing: true; apply exit 0; missing layout files: none; check exit 0; repeat apply exit 0, byte-identical: true; no copied runtime: true |
