...
//
// Kept separate from token-cost.test.mjs and its fixtures/transcripts directory on purpose: that
// file's fixtures are shared across many hand-computed assertions (see fixtures/README.md), and
...
// token-cost.mjs on 2026-09-22 (see the comment beside the table for the source and retrieval date).
