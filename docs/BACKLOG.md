...
| B25 | The project state report (`skilliton status` and the session start) treats a handoff Written time later than the current time as a problem, allowing a few minutes of clock difference, with a test; today a future time hides every later change | open, no owner input; found 2026-09-17 | lesson 2026-09-17-handoff-times-typed-ahead-of-the-clock-h-95ba |
