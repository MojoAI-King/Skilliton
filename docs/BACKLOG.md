...
| B19 (M9) | Every current technical name is Skilliton, with a migration for prepared projects and joined machines; the `SG-` control IDs stay (O23, decided) | verified locally on 5a67e74; open: the machine rehearsal's GitHub install (J8) after publishing, then archive | PLAN.md M9; docs/BRANDING.md; decision a319 |
