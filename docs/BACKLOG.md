...
| B19 (M9) | Every current technical name is Skilliton, with a migration for prepared projects and joined machines; the `SG-` control IDs stay (O23, decided) | open; order 1 in docs/PHASE-3.md | PLAN.md M9; docs/BRANDING.md |
