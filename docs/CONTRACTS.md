...
| `prepare`, `migrate`, `remove`, `status`, `task`, `checkpoint`, `record`, `index`, `security`, `hook`, `propose`, `release`, `verify`, `trust`, `join`, `delivery` | sections 10 to 14 (built in workflow 0.3.0; `join` in 0.5.0) | per command |
