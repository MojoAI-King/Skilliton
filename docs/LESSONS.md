...
| [2026-09-23-a-chained-command-commits-before-the-tes-70be](lessons/2026-09-23-a-chained-command-commits-before-the-tes-70be.md) | A chained command commits before the test verdict is read | accepted | 2026-09-23 |
| [2026-09-23-a-client-s-marketplace-remove-run-inside-0ef4](lessons/2026-09-23-a-client-s-marketplace-remove-run-inside-0ef4.md) | A client's marketplace remove run inside a repository also empties that repository's plugin settings | accepted | 2026-09-23 |
| [2026-09-23-a-docs-only-branch-still-needs-the-gener-d243](lessons/2026-09-23-a-docs-only-branch-still-needs-the-gener-d243.md) | A docs-only branch still needs the generated-records check | accepted | 2026-09-23 |
| [2026-09-23-a-lane-item-that-names-a-main-only-file-a7bc](lessons/2026-09-23-a-lane-item-that-names-a-main-only-file-a7bc.md) | A lane item that names a main-only file gets half done | accepted | 2026-09-23 |
| [2026-09-23-a-new-lint-ratchet-is-merged-last-or-eve-3323](lessons/2026-09-23-a-new-lint-ratchet-is-merged-last-or-eve-3323.md) | A new lint ratchet is merged last, or every earlier lane rebases onto it | accepted | 2026-09-23 |
...
| [2026-09-24-a-check-run-that-spans-a-system-sleep-fa-0567](lessons/2026-09-24-a-check-run-that-spans-a-system-sleep-fa-0567.md) | A check run that spans a system sleep fails steps that are not broken | accepted | 2026-09-24 |
| [2026-09-24-a-count-of-permission-prompts-that-skips-a3a6](lessons/2026-09-24-a-count-of-permission-prompts-that-skips-a3a6.md) | A count of permission prompts that skips the background agents' transcripts blames the wrong thing | accepted | 2026-09-24 |
| [2026-09-24-a-fix-that-hardens-the-writers-it-names-772e](lessons/2026-09-24-a-fix-that-hardens-the-writers-it-names-772e.md) | A fix that hardens the writers it names leaves the next writer open | accepted | 2026-09-24 |
...
| [2026-09-25-reading-the-whole-power-log-made-every-f-12f0](lessons/2026-09-25-reading-the-whole-power-log-made-every-f-12f0.md) | Reading the whole power log made every failing gate run on a Mac 9 seconds slower | accepted | 2026-09-25 |
