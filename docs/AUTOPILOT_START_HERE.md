...
| Guides | [HOW-IT-WORKS.md](HOW-IT-WORKS.md) (the whole path, with diagrams), [PHASE-3.md](PHASE-3.md) (the company-wide autopilot plan: device-management enrollment, routines, security audit, more tools), [POSITIONING.md](POSITIONING.md) (value claims and their evidence, a skeptical lead's questions, candidate next steps), [MULTIPLAYER.md](MULTIPLAYER.md) (a separate companion project for teams working with agents live; an idea, not built), [ONBOARDING.md](ONBOARDING.md), [RELEASING.md](RELEASING.md), [DELIVERY.md](DELIVERY.md), [rehearsals/NEW_BUILDER.md](rehearsals/NEW_BUILDER.md) |
