...
| Guides | [HOW-IT-WORKS.md](HOW-IT-WORKS.md) (the whole path, with diagrams), [POSITIONING.md](POSITIONING.md) (value claims and their evidence, a skeptical lead's questions, candidate next steps), [ONBOARDING.md](ONBOARDING.md), [RELEASING.md](RELEASING.md), [DELIVERY.md](DELIVERY.md), [rehearsals/NEW_BUILDER.md](rehearsals/NEW_BUILDER.md) |
