...
3. **Release 1.1.0** was signed at 09:56 EDT on 2026-09-23 (tag skilliton-release/1.1.0 on 4bf1402, approved in a fresh clone, VERIFIED 8 of 8 on this machine; evidence/live/2026-09-23-release-1.1.0.md). Restart the client before the new hooks run.
