...
- **Build progress:** `[##################..]` 92 (11 of 12) across 4 batch(es), by `node scripts/report-card.mjs --apply`
...
| [04 Dispatch suggestion (M11)](batch-04-dispatch-suggestion.md) | build | `[##########..........]` 50 (1 of 2) |
