...
- **Build progress:** `[###################.]` 95 (18 of 19) across 5 batch(es), by `node scripts/report-card.mjs --apply`
...
| Batch | Type | Progress |
|---|---|---|
| [01 Bound context (B36)](batch-01-bound-context.md) | research | `[####################]` 100 (5 of 5) |
| [02 Guard and gate in real sessions (B34)](batch-02-guard-and-gate-live.md) | measure | `[####################]` 100 (4 of 4) |
| [03 Subagent hygiene](batch-03-subagent-hygiene.md) | build | `[####################]` 100 (3 of 3) |
