...
- **Owner:** unassigned
- **Updated:** 2026-09-24T15:44:55.090Z
...
- **State:** N19 and N20 done and committed (37d9d1d, d4484e1); legacy migrations moved to scripts/legacy-migrate.mjs+legacy-migrate-plans.mjs, harness.md shrunk to 2598 bytes. Evidence: node --test scripts/migrate.test.mjs 15/15; node --test scripts/prepare.test.mjs 42/42; node --test scripts/lifecycle.test.mjs 59/59; node scripts/docs.test.mjs pass; node scripts/lint.test.mjs pass; bash scripts/scrub-check.sh pass.
- **Next:** N21: audit-finding-acted-on eval case
- **Blocked:** nothing
