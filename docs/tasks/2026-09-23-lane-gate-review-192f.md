...
- **Owner:** unassigned
- **Updated:** 2026-09-23T19:53:50.815Z
...
- **State:** N84 done: the delivery gate reads each check stream through lineReader (lib/delivery-protect.mjs), which keeps a carry over 400 characters as a line and resets it. Evidence: node scripts/delivery-protect.test.mjs exit 0 (6 pass); with the bound removed the unit test fails (carry reached 4194304); node scripts/delivery.test.mjs exit 0 (15 pass).
- **Next:** N85 hard-linked manifest refusal
- **Blocked:** nothing
