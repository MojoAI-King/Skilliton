...
- **Owner:** unassigned
- **Updated:** 2026-09-23T19:54:32.685Z
...
- **State:** N85 done: proveInside refuses a file on the way (plugin.json) with nlink > 1, exit 2, Nothing was written. Evidence: node --test scripts/skill-writers.test.mjs exit 0 (6 pass); with the nlink check removed the new test fails.
- **Next:** N86 handoff hook refuses a linked path
- **Blocked:** nothing
