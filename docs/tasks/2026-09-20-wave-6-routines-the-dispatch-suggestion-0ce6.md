...
- [x] 05-04: docs/AUTOPILOT_START_HERE.md reaches every document under docs/, superseded ones move to docs/archive/ with a Kind: Reference label, and scripts/docs.test.mjs fails on an unreachable document with a self-test case (evidence: commit f8b465e; docs/AUTOPILOT_START_HERE.md reaches every document, docs/archive/ holds the superseded ones with Kind: Reference, and scripts/docs.test.mjs fails on an unreachable document in its self-test)
