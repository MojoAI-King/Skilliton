...
- **Owner:** unassigned
- **Updated:** 2026-09-24T16:16:01.879Z
...
- **State:** N35 done: a previous session that ended dirty with no checkpoint is named at the next start (lib/previous-session.mjs). Evidence: node --test scripts/previous-session.test.mjs 6 of 6; lifecycle.test 59 of 59; session-liveness pass.
- **Next:** N36 unreadable checkpoint lines
- **Blocked:** nothing
