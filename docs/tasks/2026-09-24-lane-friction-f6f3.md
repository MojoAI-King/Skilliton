...
- **Owner:** unassigned
- **Updated:** 2026-09-24T16:38:50.674Z
...
- **State:** N39 done: verify adds one line when the clone's pin and the installed plugins' release disagree; exit unchanged. Evidence: node --test scripts/verify-pin.test.mjs 2 of 2; release, join, release-refusals, rename, allowlist pass.
- **Next:** N40 doctor outside a git repository
- **Blocked:** nothing
