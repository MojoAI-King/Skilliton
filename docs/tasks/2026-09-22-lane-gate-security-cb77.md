...
- **Owner:** unassigned
- **Updated:** 2026-09-22T23:12:47.791Z
...
- **State:** N25 built: join's URL refusal passes the requested marketplace through redact() from lib/preflight.mjs; join.mjs stays at 603 lines. Evidence: node --test scripts/join-redact.test.mjs 1 pass (it printed FAKEVALUE0123456789 before the fix); join.test.mjs 42 pass, preflight.test.mjs 24 pass; lint, deadcode, allowlist, skilliton.test exit 0.
- **Next:** N26 release refusal tests
- **Blocked:** nothing
