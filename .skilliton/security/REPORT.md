...
Missing: 0. Stale: 2. Expired: 0. Invalid: 0. Gaps: 3. Needs a human: 1.
...
| SG-RECURRING-PATTERNS | Look for recurring causes across findings | yes | gap | stale |
...
| SG-SECURITY-LOGGING | Log security events well enough to investigate them | yes | gap | stale |
